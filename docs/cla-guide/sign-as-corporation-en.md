...
<li>
<p>As a super administrator, you have the right to add or delete manager accounts. At least one manager account is required to authorize the CLA signing from your employees. You can specify a maximum of five managers. When you add a manager, the system generates a random password and sends an email to notify the manager.<br>
